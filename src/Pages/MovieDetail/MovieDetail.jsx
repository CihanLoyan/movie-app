...
const MovieDetail = () => {
    ...
    useEffect(() => {
        const isFavorite = movies?.find((movie) => movie.id == id)  // Eğer ilgili film localStorage'da ise değişkene aktar ve
    ...
    const release_year = new Date(movieDetail?.release_date)  // Sadece yıl bilgisini çekmek için.
          ...
          <div className='content'>
            <div className='left'>
                <div className='movie-backdrop_path'>
                    <img src={`${API_IMG}/${movieDetail?.poster_path}`} alt={movieDetail.title} />
                </div>
            </div>
            <div className='right'>
